...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/framework/bootstrap-fileinput/css/fileinput.min.css" /> " />
    <link rel="stylesheet" href="<c:url value="/resources/framework/bootstrap-fileinput/css/fileinput-rtl.min.css" /> " />
    <link rel="stylesheet" href="<c:url value="/resources/framework/iconfont/iconfont.css"/>">
    <link rel="stylesheet" href="<c:url value="/resources/css/common-nav.css"/>"/>
    <!--[if lt IE 9]>
    ...
    <script src="<c:url value="/resources/framework/bootstrap-fileinput/js/fileinput.min.js"/> " ></script>
    <script src="<c:url value="/resources/framework/bootstrap-fileinput/js/locales/zh.js"/> " ></script>
    ...
    <script type="application/javascript">
        ...
        //url地址，例：/shoppingServer/servlet/home/homeAction_home.action
        var URL_PATH = window.location.pathname;
        //路径全路径，例: servlet/home/homeAction_home.action
        var ALL_PATH_NAME = URL_PATH.substring(ROOT_PATH.length + 1);
    </script>
...
<c:import url="../common/common-bottom.jsp" />
